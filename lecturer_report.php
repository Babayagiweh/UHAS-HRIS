...
// Fetch lecturers
$sql = "SELECT staff_id, full_name, department, campus,date_on_present_grade, highest_qualification, dob, gender FROM staff WHERE designation = 'Lecturer'";
...
<body>
    ...
    ?>
        ...
        <p class="text-end"><strong>Total  Lecturers:</strong> <?= $count; ?></p>
    </div>
