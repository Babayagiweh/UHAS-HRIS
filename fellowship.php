...
<head>
    ...
    <title>Staff on Fellowship</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff on Fellowship</h1>
    </div>

    <div class="container my-4">
        <a href="home.php" class="btn btn-uhas mb-3">Back</a>
        <div class="table-responsive">
            <table id="fellowshipTable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>S/NO</th>
                        <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Staff on Fellowship:</strong> <?= $count; ?></p>
    </div>
