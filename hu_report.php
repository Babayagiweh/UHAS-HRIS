...
<body>
    ...
    <div class="uhas-header">
        <h1>Head of Unit List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="headOfUnitTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Heads of Unit:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#headOfUnitTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Head of Unit List'
                    },
                    {
                        extend: 'excel',
                        title: 'Head_of_Unit_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Head of Unit List'
