...
<body>
    ...
    <div class="uhas-header">
        <h1>Hall Tutor List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="hallTutorTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Hall Tutors:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#hallTutorTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Hall Tutor List'
                    },
                    {
                        extend: 'excel',
                        title: 'Hall_Tutor_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Hall Tutor List'
