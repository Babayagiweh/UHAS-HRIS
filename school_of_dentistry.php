...
<head>
    ...
    <title>School of Dentistry Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Dentistry Staff List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff in School of Dentistry:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Dentistry Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Dentistry_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Dentistry Staff List'
