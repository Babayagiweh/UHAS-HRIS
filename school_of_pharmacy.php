...
<head>
    ...
    <title>School of Pharmacy Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Pharmacy Staff List</h1>
    </div>
 ...
 <a href="schools.php" class="btn btn-secondary mb-3">Back to Schools Menu</a>
        ...
        <p class="text-end"><strong>Total Staff in School of Pharmacy:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Pharmacy Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Pharmacy_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Pharmacy Staff List'
