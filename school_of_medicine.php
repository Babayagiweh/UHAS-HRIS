...
<head>
    ...
    <title>School of Medicine Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Medicine Staff List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff in School of Medicine:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Medicine Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Medicine_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Medicine Staff List'
