...
<head>
    ...
    <title>Staff List - Trafalgar Campus</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff List - Trafalgar Campus</h1>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff List - Trafalgar Campus'
                    }, 
                    {
                        extend: 'excel',
                        title: 'Staff_Trafalgar_Campus'
                    },
                    {
                        extend: 'csv',
                        title: 'Staff_Trafalgar_Campus'
