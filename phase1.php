...
<head>
    ...
    <title>Staff List - Main Campus Phase 1</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff List - Main Campus Phase 1</h1>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff List - Main Campus Phase 1'
                    }, 
                    {
                        extend: 'excel',
                        title: 'Staff_Main_Campus_Phase_1'
                    },
                    {
                        extend: 'csv',
                        title: 'Staff_Main_Campus_Phase_1'
