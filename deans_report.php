...
<body>
    ...
    <div class="container my-4">
        ...
        <table id="deansTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Deans:</strong> <?= $count; ?></p>
    </div>
