...
<head>
    ...
    <title>Staff on Leave of Absence</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff on Leave of Absence</h1>
    </div>

    <div class="container my-4">
        <a href="home.php" class="btn btn-uhas mb-3">Back</a>
        <div class="table-responsive">
            <table id="leaveOfAbsenceTable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>S/NO</th>
                        <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Staff on Leave of Absence:</strong> <?= $count; ?></p>
    </div>
