...
// Query to fetch staff with department "Fred N. Binka School of Public Health"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'Fred N. Binka School of Public Health'";
...
<head>
    ...
    <title>Fred N. Binka School of Public Health Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Fred N. Binka School of Public Health Staff List</h1>
    </div>
    ...
    <div class="container my-4">
       <a href="schools.php" class="btn btn-secondary mb-3">Back to Schools Menu</a>
        ...
        <p class="text-end"><strong>Total Staff in Fred N. Binka School of Public Health:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Fred N. Binka School of Public Health Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'Fred_N_Binka_School_of_Public_Health_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Fred N. Binka School of Public Health Staff List'
