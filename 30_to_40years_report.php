...
<head>
    ...
    <title>Staff Between 30 and 40 Years</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff Between 30 and 40 Years of Age</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="staff30To40Table" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Display only staff between 30 to 40 years
                        if ($age >= 30 && $age < 40) {
                            echo "<tr>
                                    <td>" . ++$count . "</td>
        ...
        <p class="text-end"><strong>Total Staff Between 30 and 40 Years:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#staff30To40Table').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff Between 30 and 40 Years List'
                    },
                    {
                        extend: 'excel',
                        title: 'Staff_30_to_40_Years'
                    },
                    {
                        extend: 'pdf',
                        title: 'Staff Between 30 and 40 Years List'
