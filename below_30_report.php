...
// Query to fetch staff who are below 30 years old
...
<head>
    ...
    <title>Staff Below 30 Years</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff Below 30 Years of Age</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="staffBelow30Table" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Display only staff below 30 years
                        if ($age < 30) {
                            echo "<tr>
                                    <td>" . ++$count . "</td>
        ...
        <p class="text-end"><strong>Total Staff Below 30 Years:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#staffBelow30Table').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff Below 30 Years List'
                    },
                    {
                        extend: 'excel',
                        title: 'Staff_Below_30_Years'
                    },
                    {
                        extend: 'pdf',
                        title: 'Staff Below 30 Years List'
