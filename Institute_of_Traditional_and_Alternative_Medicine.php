...
// Query to fetch staff with department "Institute of Traditional and Alternative Medicine"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'Institute of Traditional and Alternative Medicine'";
...
<head>
    ...
    <title>Institute of Traditional and Alternative Medicine Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Institute of Traditional and Alternative Medicine Staff List</h1>
    </div>

    <div class="container my-4">
        <a href="institutes.php" class="btn btn-secondary mb-3">Back to Institutes</a>
        ...
        <p class="text-end"><strong>Total Staff in Institute of Traditional and Alternative Medicine:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Institute of Traditional and Alternative Medicine Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'Institute_of_Traditional_and_Alternative_Medicine_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Institute of Traditional and Alternative Medicine Staff List'
