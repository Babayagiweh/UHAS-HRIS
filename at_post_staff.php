...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff at Post (Duty Status: AP)</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff at Post:</strong> <?= $count; ?></p>
    </div>
