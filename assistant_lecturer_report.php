...
// Fetch assistant lecturers data
$sql = "SELECT staff_id, full_name, department, date_on_present_grade, highest_qualification, dob,campus FROM staff WHERE designation = 'Assistant Lecturer'";
...
<head>
    ...
    <title>Assistant Lecturers List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Assistant Lecturers List</h1>
    </div>
    ...
    ?>
        ...
        <p class="text-end"><strong>Total Assistant Lecturers:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#assistantLecturersTable').DataTable({
