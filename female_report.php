...
// Query to fetch all female staff
...
<head>
    ...
    <style>
        ...
        .uhas-header {
            background-color: green; /* Purple for variation */
            color: white;
            text-align: center;
            padding: 10px;
        }
...
<body>
    ...
    <div class="uhas-header">
        <h1>Female Staff List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="femaleStaffTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Female Staff:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#femaleStaffTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Female Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'Female_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Female Staff List'
