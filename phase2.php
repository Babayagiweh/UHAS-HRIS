...
<head>
    ...
    <title>Staff List - Sokode Main Campus Phase 2</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff List - Sokode Main Campus Phase 2</h1>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff List - Sokode Main Campus Phase 2'
                    }, 
                    {
                        extend: 'excel',
                        title: 'Staff_Sokode_Main_Campus_Phase_2'
                    },
                    {
                        extend: 'csv',
                        title: 'Staff_Sokode_Main_Campus_Phase_2'
