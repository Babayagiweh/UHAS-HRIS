...
// Fetch associate professors data
$sql = "SELECT staff_id, full_name, department, campus FROM staff WHERE designation = 'Associate Professor'";
...
<head>
    ...
    <title>Associate Professors List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Associate Professors List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="associateProfessorsTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Name</th>
        ...
        <p class="text-end"><strong>Total Associate Professors:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#associateProfessorsTable').DataTable({
