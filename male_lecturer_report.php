...
<head>
    ...
    <title>Male Lecturers List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Male Lecturers List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="maleLecturersTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Male Lecturers:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#maleLecturersTable').DataTable({
                dom: 'Bfrtip', // Add export buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Male Lecturers List'
                    }, 
                    {
                        extend: 'excel',
                        title: 'Male_Lecturers'
                    },
                    {
                        extend: 'csv',
                        title: 'Male_Lecturers'
