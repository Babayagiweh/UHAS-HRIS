...
// Query to fetch staff with department "School of Allied Health Science"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'School of Allied Health Science'";
...
<head>
    ...
    <title>School of Allied Health Science Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Allied Health Science Staff List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff in School of Allied Health Science:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Allied Health Science Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Allied_Health_Science_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Allied Health Science Staff List'
