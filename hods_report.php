...
<body>
    ...
    <div class="uhas-header">
        <h1>Heads of Department (HoDs)</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="hodTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Heads of Department:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#hodTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Heads of Department List'
                    },
                    {
                        extend: 'excel',
                        title: 'HoD_List'
