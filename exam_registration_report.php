...
// Query to fetch staff with other_appointment as Examination/Registration Officer
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE other_appointment = 'Examination/Registration Officer'";
...
<head>
    ...
    <title>Examination/Registration Officer List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Examination/Registration Officer List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="examinationRegistrationOfficerTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Examination/Registration Officers:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#examinationRegistrationOfficerTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Examination/Registration Officer List'
                    },
                    {
                        extend: 'excel',
                        title: 'Examination_Registration_Officer_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Examination/Registration Officer List'
