...
<head>
    ...
    <title>Vacation of Post Menu</title>
...
<!-- Content Section -->
<div class="content">
    <h1>Welcome to the Vacation of Post Management Page</h1>
    <p>Select an option from the list to view its details.</p>

    <!-- Institutes List -->
    <div class="report-list-container">
        <ul class="report-list">
            <li class="report-item"><a href="add_vacated_staff.php" title="Add a Staff">1. Add a Staff</a></li>
            <li class="report-item"><a href="vacated_staff_report.php" title="View Vacated Staff List">2. Vacated Staff List</a></li>
        </ul>
    </div>
</div>
