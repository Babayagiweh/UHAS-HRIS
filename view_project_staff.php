...
// Fetch filtered data with pagination from project_staff table
$sql = "SELECT * FROM project_staff $filter_query LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Count total rows for pagination
$total_sql = "SELECT COUNT(*) AS total FROM project_staff $filter_query";
$total_result = $conn->query($total_sql);
$total_rows = $total_result->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $limit);

// Fetch distinct departments and designations for filters
$departments = $conn->query("SELECT DISTINCT department FROM project_staff");
$designations = $conn->query("SELECT DISTINCT designation FROM project_staff");
?>
...
<div class="container mt-4">
    ...
    <form method="GET" action="export_project_staff.php" class="mt-3">
        ...
        <button><a href="project_staff_mgt.php" class="btn btn-uhas mb-3">Back</a></button> 
    </form>
