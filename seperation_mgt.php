...
<!-- Content Section -->
<div class="content">
    <h1>Separation Management Page</h1>
    <p>Select an option from the list to view its details.</p>

    <!-- Separation List -->
    <div class="report-list-container">
        <ul class="report-list">
            <li class="report-item"><a href="resignation_mgt.php" title="Resignation Management">1. Resignations</a></li>
            <li class="report-item"><a href="retired_mgt.php" title="Retirement Management">2. Retirement</a></li>
            <li class="report-item"><a href="death_mgt.php" title="Death Management">3. Death</a></li>
            <li class="report-item"><a href="vacation.php" title="Vacation of Post Management">4. Vacation of Post</a></li>
        </ul>
    </div>
</div>
