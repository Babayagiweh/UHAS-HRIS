...
// Query to fetch staff with department "School of Basic and Biomedical Sciences"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'School of Basic and Biomedical Sciences'";
...
<head>
    ...
    <title>School of Basic and Biomedical Sciences Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Basic and Biomedical Sciences Staff List</h1>
    </div>

    <div class="container my-4">
       <a href="schools.php" class="btn btn-secondary mb-3">Back to Schools Menu</a>
        ...
        <p class="text-end"><strong>Total Staff in School of Basic and Biomedical Sciences:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Basic and Biomedical Sciences Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Basic_and_Biomedical_Sciences_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Basic and Biomedical Sciences Staff List'
