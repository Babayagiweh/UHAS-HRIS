...
<!-- Content Section -->
<div class="content">
    <h1>Welcome to the Deceased Management Page</h1>
    <p>Select an option from the list to view its details.</p>

    <!-- Institutes List -->
    <div class="report-list-container">
        <ul class="report-list">
            <li class="report-item"><a href="add_death.php" title="Add Deceased Staff">1. Add Deceased Staff</a></li>
            <li class="report-item"><a href="death_reports.php" title="View Deceased Staff Report">2. Detail Deceased Staff Lists</a></li>
        </ul>
    </div>
</div>
