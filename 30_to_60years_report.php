...
<head>
    ...
    <title>Staff Between 30 and 60 Years</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff Between 30 and 60 Years of Age</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="staff30To60Table" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Display only staff between 30 to 60 years
                        if ($age >= 30 && $age <= 60) {
                            echo "<tr>
                                    <td>" . ++$count . "</td>
        ...
        <p class="text-end"><strong>Total Staff Between 30 and 60 Years:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#staff30To60Table').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff Between 30 and 60 Years List'
                    },
                    {
                        extend: 'excel',
                        title: 'Staff_30_to_60_Years'
                    },
                    {
                        extend: 'pdf',
                        title: 'Staff Between 30 and 60 Years List'
