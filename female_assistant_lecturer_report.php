...
<head>
    ...
    <title>Female Assistant Lecturers List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Female Assistant Lecturers List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="assistantLecturersTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Female Assistant Lecturers:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#assistantLecturersTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Female Assistant Lecturers List'
                    },
                    {
                        extend: 'excel',
                        title: 'Female_Assistant_Lecturers'
                    },
                    {
                        extend: 'csv',
                        title: 'Female_Assistant_Lecturers'
