...
<head>
    ...
    <title>Staff 60 and Above</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff Aged 60 and Above</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="staff60AndAboveTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Display only staff aged 60 and above
                        if ($age >= 60) {
                            echo "<tr>
                                    <td>" . ++$count . "</td>
        ...
        <p class="text-end"><strong>Total Staff 60 and Above:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#staff60AndAboveTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Staff 60 and Above List'
                    },
                    {
                        extend: 'excel',
                        title: 'Staff_60_and_Above'
                    },
                    {
                        extend: 'pdf',
                        title: 'Staff 60 and Above List'
