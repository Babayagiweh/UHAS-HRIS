...
<!-- Content Section -->
<div class="content">
    <h1>Welcome to the Retired Management Page</h1>
    <p>Select an option from the list to view its details.</p>

    <!-- Separation List -->
    <div class="report-list-container">
        <ul class="report-list">
            <li class="report-item"><a href="add_retiree.php" title="Add Approved Retiree">1. Add Approved Retiree</a></li>
            <li class="report-item"><a href="retiree_reports.php" title="View Detailed Retiree List">2. Detailed Retiree List</a></li>
        </ul>
    </div>
</div>
