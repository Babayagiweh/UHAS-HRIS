...
<body>
    ...
    <div class="uhas-header">
        <h1>Male Staff List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="maleStaffTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Male Staff:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#maleStaffTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Male Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'Male_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Male Staff List'
