...
<head>
    ...
    <title>Staff on Study Leave Without Pay (SL-P)</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff on Study Leave Without Pay (SL-P)</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff on Study Leave Without Pay:</strong> <?= $count; ?></p>
    </div>
