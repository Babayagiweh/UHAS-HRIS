...
// Fetch permanent staff data
$sql = "SELECT staff_id, full_name, department, campus FROM staff WHERE employee_status = 'permanent'";
...
<head>
    ...
    <title>Permanent Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Permanent Staff List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="permanentStaffTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Name</th>
        ...
        <p class="text-end"><strong>Total Permanent Staff:</strong> <?= $count; ?></p>
    </div>
