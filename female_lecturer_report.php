...
<head>
    ...
    <title>Female Lecturers List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Female Lecturers List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="femaleLecturersTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Female Lecturers:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#femaleLecturersTable').DataTable({
                dom: 'Bfrtip', // Add export buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Female Lecturers List'
                    },
                    {
                        extend: 'excel',
                        title: 'Female_Lecturers'
                    },
                    {
                        extend: 'csv',
                        title: 'Female_Lecturers'
