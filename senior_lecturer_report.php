...
// Fetch senior lecturers data
$sql = "SELECT staff_id, full_name, department, date_on_present_grade, highest_qualification, dob, campus FROM staff WHERE designation = 'Senior Lecturer'";
...
<head>
    ...
    <title>Senior Lecturers List</title>
...
<body>
    ...
    ?>
        ...
        <p class="text-end"><strong>Total Senior Lecturers:</strong> <?= $count; ?></p>
    </div>
