...
// Query to fetch staff with department "School of Sports and Exercise Medicine"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'School of Sports and Exercise Medicine'";
...
<head>
    ...
    <title>School of Sports and Exercise Medicine Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Sports and Exercise Medicine Staff List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff in School of Sports and Exercise Medicine:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Sports and Exercise Medicine Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Sports_and_Exercise_Medicine_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Sports and Exercise Medicine Staff List'
