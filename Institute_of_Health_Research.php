...
// Query to fetch staff with department "Institute of Health Research"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'Institute of Health Research'";
...
<head>
    ...
    <title>Institute of Health Research Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Institute of Health Research Staff List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Staff in Institute of Health Research:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Institute of Health Research Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'Institute_of_Health_Research_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Institute of Health Research Staff List'
