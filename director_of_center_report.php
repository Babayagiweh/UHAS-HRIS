...
// Query to fetch staff with other_appointment as Director of Center
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE other_appointment = 'Director of Center'";
...
<head>
    ...
    <title>Director of Center List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Director of Center List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-secondary mb-3">Back to Reports</a>
        <table id="directorOfCenterTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/No</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Directors of Center:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#directorOfCenterTable').DataTable({
                dom: 'Bfrtip', // Add export and print buttons
                buttons: [
                    {
                        extend: 'print',
                        title: 'Director of Center List'
                    },
                    {
                        extend: 'excel',
                        title: 'Director_of_Center_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'Director of Center List'
