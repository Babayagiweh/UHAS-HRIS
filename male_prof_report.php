...
<head>
    ...
    <title>Male Professors List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Male Professors List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="maleProfessorsTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Male Professors:</strong> <?= $count; ?></p>
    </div>
