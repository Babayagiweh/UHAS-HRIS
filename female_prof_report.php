...
<head>
    ...
    <title>Female Professors List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Female Professors List</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="femaleProfessorsTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Staff ID</th>
        ...
        <p class="text-end"><strong>Total Female Professors:</strong> <?= $count; ?></p>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#femaleProfessorsTable').DataTable({
