...
// Query to fetch staff with department "School of Nursing and Midwifery"
$sql = "SELECT staff_id, full_name, department, campus, designation, date_on_present_grade, dob, highest_qualification 
        FROM staff 
        WHERE department = 'School of Nursing and Midwifery'";
...
<head>
    ...
    <title>School of Nursing and Midwifery Staff List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>School of Nursing and Midwifery Staff List</h1>
    </div>
 ...
 <a href="schools.php" class="btn btn-secondary mb-3">Back to Schools Menu</a>
        ...
        <p class="text-end"><strong>Total Staff in School of Nursing and Midwifery:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#staffTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'School of Nursing and Midwifery Staff List'
                    },
                    {
                        extend: 'excel',
                        title: 'School_of_Nursing_and_Midwifery_Staff_List'
                    },
                    {
                        extend: 'pdf',
                        title: 'School of Nursing and Midwifery Staff List'
