...
// Fetch staff with PhD as highest qualification
$sql = "SELECT staff_id, full_name, department, campus FROM staff WHERE highest_qualification = 'PhD'";
...
<body>
    ...
    <div class="uhas-header">
        <h1>Staff with PhD Qualification</h1>
    </div>

    <div class="container my-4">
        <a href="reports.php" class="btn btn-uhas mb-3">Back</a>
        <table id="phdStaffTable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>S/NO</th>
                    <th>Name</th>
        ...
        <p class="text-end"><strong>Total Staff with PhD:</strong> <?= $count; ?></p>
    </div>
