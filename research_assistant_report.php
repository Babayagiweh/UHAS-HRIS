...
// Fetch research assistants data
$sql = "SELECT staff_id, full_name, department, campus FROM staff WHERE designation = 'Research Assistant'";
...
<head>
    ...
    <title>Research Assistants List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Research Assistants List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Research Assistants:</strong> <?= $count; ?></p>
    </div>
