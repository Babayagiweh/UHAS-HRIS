...
<head>
    ...
    <title>Male Assistant Lecturers List</title>
...
<body>
    ...
    <div class="uhas-header">
        <h1>Male Assistant Lecturers List</h1>
    </div>
    ...
    <div class="container my-4">
        ...
        <p class="text-end"><strong>Total Male Assistant Lecturers:</strong> <?= $count; ?></p>
    </div>
        ...
        $(document).ready(function() {
            $('#assistantLecturersTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'print',
                        title: 'Male Assistant Lecturers List'
                    },
                    {
                        extend: 'excel',
                        title: 'Male_Assistant_Lecturers'
                    },
                    {
                        extend: 'csv',
                        title: 'Male_Assistant_Lecturers'
